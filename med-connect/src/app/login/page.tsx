          ...
          <div className="w-full max-w-md animate-fade-in-up">
            <Card className="p-8 md:p-10 shadow-xl shadow-blue-500/5 border-0 ring-1 ring-gray-100">
              ...
              <button
                ...
                type="button"
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl bg-white text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-300 animate-fade-in-up delay-400"
              >
